...
FAST Certification Test #26: NREL 5.0 MW Baseline Wind Turbine (Onshore) - Customized
---------------------- SIMULATION CONTROL --------------------------------------
...
---------------------- INPUT FILES ---------------------------------------------
"NRELOffshrBsline5MW_Onshore_ElastoDyn_BDoutputs_Skewed_Loads.dat"    EDFile          - Name of file containing ElastoDyn input parameters (quoted string)
...
"../5MW_Baseline/NRELOffshrBsline5MW_InflowWind_12mps_cp_curve.dat"    InflowFile      - Name of file containing inflow wind input parameters (quoted string)
"NRELOffshrBsline5MW_Onshore_AeroDyn_Skewed_Loads.dat"    AeroFile        - Name of file containing aerodynamic input parameters (quoted string)
"NRELOffshrBsline5MW_Onshore_ServoDyn_Skewed_Loads.dat"    ServoFile       - Name of file containing control and electrical-drive input parameters (quoted string)
