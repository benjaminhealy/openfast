...
! =========  AD_InputFile  =======
  TYPE, PUBLIC :: AD_InputFile
    ...
    INTEGER(IntKi)  :: SkewMomCorr = 0_IntKi      !< Momentum correction method: 0=None, 1=Glauert, 2=UMM iterative, 3=UMM tabulated [-]
    CHARACTER(1024)  :: UMM_PressureFile      !< Path to UMM pressure table file [required when SkewMomCorr=2] [quoted strings]
    CHARACTER(1024)  :: UMM_InductionFile      !< Path to UMM induction table file [required when SkewMomCorr=3] [quoted strings]
...
subroutine AD_CopyInputFile(SrcInputFileData, DstInputFileData, CtrlCode, ErrStat, ErrMsg)
   ...
   DstInputFileData%UMM_InductionFile = SrcInputFileData%UMM_InductionFile
...
subroutine AD_PackInputFile(RF, Indata)
   ...
   call RegPack(RF, InData%UMM_InductionFile)
...
subroutine AD_UnPackInputFile(RF, OutData)
   ...
   call RegUnpack(RF, OutData%UMM_InductionFile); if (RegCheckErr(RF, RoutineName)) return
